			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="application.name.label" default="Name" /></th>
					
						<th><g:message code="application.opportunity.label" default="Opportunity" /></th>
				...
				<g:each in="${applicationInstanceList}" status="i" var="applicationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: applicationInstance, field: "opportunity")}</td>
